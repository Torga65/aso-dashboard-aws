...
let _imsToken = null;    // raw IMS token from parent — used directly as Bearer for SpaceCat
let _profile = null;
let _ready = false;
...
/** True when a valid IMS token is available. */
export function isAuthenticated() {
  return !!_imsToken;
}

/** Returns the IMS token for API calls (used directly as Bearer for SpaceCat). */
