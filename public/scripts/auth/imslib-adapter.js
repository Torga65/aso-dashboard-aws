...
let _imsToken = null;  // raw IMS token from parent; proxy handles SpaceCat exchange
let _profile = null;
let _ready = false;
...
/** Returns the raw IMS token — the Next.js proxy handles SpaceCat token exchange. */
